...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-08-24}
  s.description = %q{Simple authorization}
  ...
  s.files = ["Manifest", "README.rdoc", "Rakefile", "lib/turnstile.rb", "lib/turnstile/authorization.rb", "lib/turnstile/role.rb", "lib/turnstile/rule.rb", "turnstile.gemspec"]
